// FILEPATH: frontend/src/domains/meta_v2/features/dictionary/components/editor/PreviewPanel.tsx
// @file: Live Preview Panel (V2)
// @author: The Engineer
...
export const PreviewPanel: React.FC<PreviewPanelProps> = ({ draft }) => {
    ...
    const renderWidget = () => {
        ...
        if (widget_type === WidgetType.COLOR_PICKER) return <Input type="color" style={{ width: 64, padding: 0, border: 'none' }} {...props} />;
