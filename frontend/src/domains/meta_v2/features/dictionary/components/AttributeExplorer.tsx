// FILEPATH: frontend/src/domains/meta_v2/features/dictionary/components/AttributeExplorer.tsx
// @file: Attribute Explorer (List View - V2)
// @author: The Engineer
// @description: Navigable list of Domain Attributes.
// FEATURES:
// Smart Sorting (System fields first).
// URL-Driven Search (Deep Linking).
// Decoupled from V1.
...
export const AttributeExplorer: React.FC<AttributeExplorerProps> = ({
  ...
  useTrace('AttributeExplorerV2', { count: attributes.length, collapsed });
