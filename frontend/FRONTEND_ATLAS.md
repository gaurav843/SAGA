...
---
## 📂 `frontend/src/domains/meta/_kernel/`
...
---
## 📂 `frontend/src/domains/meta/features/app_studio/`
...
---
## 📂 `frontend/src/domains/meta/features/app_studio/components/`
...
---
## 📂 `frontend/src/domains/meta/features/app_studio/hooks/`
...
---
## 📂 `frontend/src/domains/meta/features/cortex/`
...
---
## 📂 `frontend/src/domains/meta/features/dictionary/`
...
---
## 📂 `frontend/src/domains/meta/features/dictionary/components/`
...
* **`AttributeEditor`**
  * **Logic Flow:**
    ...
    * `⚡ CRITICAL FIX: Pass 'configuration', not 'config'`
...
---
## 📂 `frontend/src/domains/meta/features/dictionary/components/editor/`
...
* **`ConfigPanels`**
  * **Logic Flow:**
    * `⚡ CRASH GUARD: Ensure we have an object to read from [cite: 1090]`
...
---
## 📂 `frontend/src/domains/meta/features/dictionary/hooks/`
...
---
## 📂 `frontend/src/domains/meta/features/dictionary/logic/`
...
---
## 📂 `frontend/src/domains/meta/features/dictionary/types/`
...
---
## 📂 `frontend/src/domains/meta/features/governance/`
...
---
## 📂 `frontend/src/domains/meta/features/governance/components/`
...
---
## 📂 `frontend/src/domains/meta/features/governance/components/editor/`
...
---
## 📂 `frontend/src/domains/meta/features/governance/components/editor/logic/`
...
---
## 📂 `frontend/src/domains/meta/features/governance/hooks/`
...
---
## 📂 `frontend/src/domains/meta/features/governance/types/`
...
---
## 📂 `frontend/src/domains/meta/features/policy_groups/`

### 📄 `PolicyGroupsView.tsx`
...
---
## 📂 `frontend/src/domains/meta/features/policy_groups/components/`
...
---
## 📂 `frontend/src/domains/meta/features/policy_groups/hooks/`
...
* **`PolicyGroup`**
  * 📝 *TypeScript interfaces for Policy Bundles.*
  * **Logic Flow:**
...
---
## 📂 `frontend/src/domains/meta/features/runner/`
...
---
## 📂 `frontend/src/domains/meta/features/states/`
...
---
## 📂 `frontend/src/domains/meta/features/states/components/`

### 📄 `CodeEditorDrawer.tsx`
...
* **`InspectorPanel`**
  * 📝 *The Inspector Panel handles the contextual editing of Nodes, Edges, and Workflow Properties.*
  * **Logic Flow:**
...
---
## 📂 `frontend/src/domains/meta/features/states/components/canvas/`
...
---
## 📂 `frontend/src/domains/meta/features/states/components/canvas/nodes/`
...
---
## 📂 `frontend/src/domains/meta/features/states/components/inspector/`
...
* **`InspectorShell`**
  * 📝 *Standardized container for all Inspector panels.*
  * **Logic Flow:**
    * `🔍 DEBUG TRACE`
    * `--- RENDERERS ---`
...
* **`NodeInspector`**
  * 📝 *The Brain of the Inspector. Routes to the correct editor.*
  * **Logic Flow:**
...
---
## 📂 `frontend/src/domains/meta/features/states/components/inspector/governance/`
...
---
## 📂 `frontend/src/domains/meta/features/states/components/inspector/jobs/`
...
---
## 📂 `frontend/src/domains/meta/features/states/components/inspector/wizard/`
...
* **`AIComposer`**
  * 📝 *The centralized orchestrator for AI-assisted form generation.*
  * **Logic Flow:**
    * `Optional Injections`
    * `--- 1. UI STATE ---`
...
---
## 📂 `frontend/src/domains/meta/features/states/components/inspector/wizard/components/ContextBrowser/`
...
* **`ComponentGallery`**
  * 📝 *Renders a filterable grid of UI components.*
  * **Logic Flow:**
    * `⚡ COMPUTE CATEGORIES`
    * `⚡ FILTER LIST`
...
* **`DataPicker`**
  * 📝 *Renders a list of available Data Domains.*
  * **Logic Flow:**
    * `⚡ THEME FIX: Use Tokens instead of Hardcoded Hex`

---
### 📄 `GovernancePicker.tsx`
...
* **`GovernancePicker`**
  * 📝 *Renders a dual-view picker for Governance constraints.*
  * **Logic Flow:**
    * `⚡ FILTER LOGIC`
...
* **`WorkflowPicker`**
  * 📝 *Renders a searchable list of workflows grouped by intent.*
  * **Logic Flow:**
    * `⚡ FILTER & GROUP LOGIC`
    * `1. Text Filter`
...
* **`ContextBrowser`**
  * 📝 *The main container for the Context Selection Interface.*
  * **Logic Flow:**
    * `⚡ DYNAMIC STYLING (Semantic)`
    * `We rely on the parent ConfigProvider (Dark Algorithm) to set token values correctly.`

---
## 📂 `frontend/src/domains/meta/features/states/components/inspector/wizard/components/`
...
---
## 📂 `frontend/src/domains/meta/features/states/components/inspector/wizard/hooks/`

### 📄 `useContextAssembler.ts`
...
---
## 📂 `frontend/src/domains/meta/features/states/components/inspector/wizards/`
...
---
## 📂 `frontend/src/domains/meta/features/states/hooks/`
...
---
## 📂 `frontend/src/domains/meta/features/states/logic/`
...
* **`toGraph`**
  * 📝 *Converts backend JSON into Graph Nodes/Edges and back.*
  * **Logic Flow:**
    * `1. Build Nodes`
...
---
## 📂 `frontend/src/domains/meta/features/states/types/`
...
---
## 📂 `frontend/src/domains/meta/types/`
...
---
## 📂 `frontend/src/domains/meta/views/`

### 📄 `MetaDashboard.tsx`
> The clean entry point for the new System Configurator.

---
## 📂 `frontend/src/domains/meta_v2/`
...
---
## 📂 `frontend/src/domains/meta_v2/_kernel/`
...
* **`calculateCapabilities`**
  * 📝 *Decodes the Domain Properties into UI Capabilities.*
  * **Logic Flow:**
...
* **`buildActiveContext`**
  * 📝 *Factory that builds the Context Object from a selected Domain.*
  * **Logic Flow:**
...
---
## 📂 `frontend/src/domains/meta_v2/_shell/`
...
---
## 📂 `frontend/src/domains/meta_v2/components/`

### 🛠️ `ContextInspector.tsx`
...
* **`DomainTopology`**
  * 📝 *Renders the System Hierarchy using a Recursive Engine.*
  * **Logic Flow:**
    * `1. DATA`
    * `2. STATE`
    * `3. ROUTING LOGIC`
...
---
## 📂 `frontend/src/domains/meta_v2/features/dictionary/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/dictionary/components/`
...
* **`AttributeExplorer`**
  * **Logic Flow:**
    * `⚡ DEEP LINKING: Replaced local state with URL state for search persistence`
    * `🧠 SMART SORTING`
...
---
## 📂 `frontend/src/domains/meta_v2/features/dictionary/components/editor/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/dictionary/hooks/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/dictionary/logic/`
...
* **`normalizeSchema`**
  * 📝 *V2 Types now contain Enums too*
  * **Logic Flow:**
    * `Scenario A: It's already an Array`
    * `Scenario B: It's a Hybrid Schema Object`
    * `Check possible containers`
...
---
## 📂 `frontend/src/domains/meta_v2/features/dictionary/types/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/governance/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/governance/components/editor/`

### 📄 `ConsequenceStack.tsx`
...
---
## 📂 `frontend/src/domains/meta_v2/features/governance/components/editor/logic/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/governance/hooks/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/workflows/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/workflows/components/`

### 🛠️ `CodeEditorDrawer.tsx`
...
* **`CodeEditorDrawer`**
  * 📝 *The low-level interface for direct XState manipulation.*
  * **Logic Flow:**
...
* **`EditorToolbar`**
  * 📝 *The top navigation bar for the workflow editor.*
...
---
## 📂 `frontend/src/domains/meta_v2/features/workflows/components/canvas/`
...
---
## 📂 `frontend/src/domains/meta_v2/features/workflows/components/inspector/`
...
* **`SelectionType`**
* **`InspectorShell`**
  * 📝 *Renders the high-density container for node editing. [cite: 2855-2884]*
  * **Logic Flow:**
...
* **`JobNode`**
  * 📝 *Decoupled V2 editor for background task nodes. [cite: 2885-2923]*
  * **Logic Flow:**
...
* **`StandardNode`**
  * 📝 *Decoupled V2 editor for basic state nodes. [cite: 2954-2981]*
  * **Logic Flow:**
    * `⚡ SIGNAL TELEMETRY: Init`
...
* **`TransitionEdge`**
  * 📝 *Decoupled V2 inspector for Workflow Edges. [cite: 2988-3027]*
  * **Logic Flow:**
...
* **`WIZARD_COMPONENTS`**
  * 📝 *Rich component registry for user-facing selection [cite: 3034-3048] */*
* **`WizardNode`**
  * **Logic Flow:**
...
---
## 📂 `frontend/src/domains/meta_v2/features/workflows/components/inspector/_atoms/`
...
* **`FieldCard`**
  * 📝 *Atomic component for managing the list of fields within a Wizard step. [cite: 3069-3101]*
...
---
## 📂 `frontend/src/domains/meta_v2/features/workflows/hooks/`
...
---
## 📂 `frontend/src/domains/system/api/`
...
---
## 📂 `frontend/src/domains/system/features/admin_console/`
...
---
## 📂 `frontend/src/domains/system/features/identity/`

### 📄 `SystemIdentityCard.tsx`
...
---
## 📂 `frontend/src/domains/system/hooks/`
...
---
## 📂 `frontend/src/domains/workspace/features/widget_runner/`
...
---
## 📂 `frontend/src/domains/workspace/hooks/`
...
---
## 📂 `frontend/src/domains/workspace/`
...
---
## 📂 `frontend/src/domains/workspace/views/`

### 📄 `WorkspaceRuntime.tsx`
...
---
## 📂 `frontend/src/platform/design/system/`
...
* **`useUrlState`**
  * 📝 *Creates a state variable that syncs with a URL query parameter.*
  * **Logic Flow:**
...
---
## 📂 `frontend/src/platform/ui/animation/`
...
---
## 📂 `frontend/src/platform/ui/icons/`
...
---
## 📂 `frontend/src/platform/ui/layout/`
...
---
## 📂 `frontend/src/platform/ui/widgets/`

### 📄 `ActionButtonWidget.tsx`
...
---
## 📂 `frontend/src/platform/workflow/`
...
---
## 📂 `frontend/src/platform/workflow/api/`
...
---
## 📂 `frontend/src/platform/workflow/components/`
...
---
## 📂 `frontend/src/platform/workflow/logic/`
...
---
## 📂 `frontend/src/platform/workflow/wizard-engine/`
...
---
## 📂 `frontend/src/platform/workflow/wizard-engine/hooks/`
...
---
## 📂 `frontend/src/platform/workflow/wizard-engine/logic/`
...
---
## 📂 `frontend/src/platform/workflow/wizard-engine/renderers/`
...
---
## 📂 `frontend/src/platform/workflow/wizard-engine/utils/`
...
---
## 📂 `frontend/src/platform/workflow/wizard-engine/wrappers/`

### 📄 `DependencyWrapper.tsx`
